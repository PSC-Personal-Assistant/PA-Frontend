...
const Locate = () => {
  return (
    <div className='container py-14 flex flex-col md:flex-row '>
      <div className='flex-1'>
        <img src={Map} alt="" />
      </div>
      <div className='space-y-5 lg:space-y-20 flex-1 px-6'>
        ...
        <button className='pryBtn text-[12px] lg:text-[14px]'>LOCATE AN ASSISTANT NEAR YOU</button>
      </div>
    </div>
  )
}
